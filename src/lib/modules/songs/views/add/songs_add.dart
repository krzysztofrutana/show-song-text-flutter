...
class _SongsAddState extends State<SongsAdd>
        ...
        builder: (context, state) {
          ...
          return Scaffold(
              appBar: AppBar(
                ...
                title: Text(localizations.addSong),
                centerTitle: true,
                actions: [
                  IconButton(
                      ...
                      onPressed: () =>
                          _onSearchClick(context, cubit, localizations)),
                  IconButton(
                    padding: const EdgeInsets.all(10),
                    iconSize: 30,
                            ...
                            child: Column(
                              children: [
                                Form(
                                  ...
                                  child: Column(
                                    children: [
                                      BlocTextFormField<SongsAddCubit,
                                          SongsAddState>(
                                        bloc: cubit,
  ...
  Future<void> _onSearchClick(BuildContext builderContext,
      SongsAddCubit songAddCubit, AppLocalizations localizations) async {
    ...
    final songToFind =
        SongToFindModel(songAddCubit.state.author, songAddCubit.state.title);
