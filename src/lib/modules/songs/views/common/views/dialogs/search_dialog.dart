...
class _SearchDialogState extends State<SearchDialog> {
              ...
              child: Column(
                children: [
                  Visibility(
                    ...
                    child: Text(_getTextByStatus(state.status, localizations)),
                  ),
                  Visibility(
                    visible: state.status == ResultState.textFinded,
  ...
  void initSearch(BuildContext context) {
    ...
    if (songToFind!.title != null &&
      ...
      _getChooseDialog(
        context,
        context.read<SongSearchCubit>().searchByArtists(),
      );
      return;
      ...
      _getChooseDialog(
        context,
        context.read<SongSearchCubit>().searchSongByTitle(),
      );
      return;
    }
  }
