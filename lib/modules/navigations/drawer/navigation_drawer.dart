...
class MyNavigationDrawer extends StatelessWidget {
  final List<_NavigationItem> _listItems = [
    _NavigationItem(true, NavigationPage.header, 'Header', const AssetImage('')),
    _NavigationItem(
        false, NavigationPage.songs_list, "Lista utworów", const AssetImage('assets/images/icons/note.png')),
    _NavigationItem(false, NavigationPage.playlist_list, "Listy odtwarzania",
        const AssetImage('assets/images/icons/playlist.png')),
    _NavigationItem(
        false, NavigationPage.settings, "Ustawienia", const AssetImage('assets/images/icons/settings.png')),
  ];
